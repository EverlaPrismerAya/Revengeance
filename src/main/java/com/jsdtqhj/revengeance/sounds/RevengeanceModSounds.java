...
public class RevengeanceModSounds {
	public static final DeferredRegister<SoundEvent> REGISTRY = DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, RevengeanceMod.MODID);
	public static final DeferredHolder<SoundEvent, SoundEvent> RAGE_ACTIVITE = REGISTRY.register("rage_activite", 
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> ADRENALINE_ACTIVITE = REGISTRY.register("adrenaline_activite",
		() -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryParse(RevengeanceMod.MODID + ":adrenaline_activite")));
	public static final DeferredHolder<SoundEvent, SoundEvent> ADRENALINE_FULL = REGISTRY.register("adrenaline_full",
